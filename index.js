...
const NUMERO_OFICIAL = "55XXXXXXXXXXX"; // O número da patroa (Ex: 5511999999999)
const NUMERO_TESTE   = "55XXXXXXXXXXX"; // O seu número para testes
...
const client = new Client({
    ...
    puppeteer: {
        executablePath: '/usr/bin/chromium-browser', // Caminho do Chromium no Armbian
        args: [
            '--no-sandbox',
